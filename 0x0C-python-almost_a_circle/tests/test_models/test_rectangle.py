...
class Test_Rectangle_basics(TestCase):
    """test cases for Rectangle initializertion"""
    ...
    def test_Rectangle_only_required(self):
        self.assertEqual(Rectangle(4, 4).id, 1)
        self.assertEqual(Rectangle(6, 4).id, 2)
...
class Test_Rectangle_values(TestCase):
    """Test cases for Rectangle input, getter and setter values."""
    ...
    types = [
        ...
        ("Betty", "AlxSchool"),
        range(42),
        {"first": "Betty", "last": "AlxSchool"},
        {"Betty", "AlxSchool"},
        frozenset({"Betty", "AlxSchool"}),
        True,
        b"Betty AlxSchool",
        bytearray(42),
        memoryview(bytes(42))
    ...
    def width_invalid_value_tests(self):
        with self.assertRaisesRegex(ValueError, "width must be > 0"):
            Rectangle(-42, 4)
        with self.assertRaisesRegex(ValueError, "width must be > 0"):
            Rectangle(0, 4)

    def height_invalid_type_tests(self):
        for type in self.types:
            with self.subTest(type=type):
                with self.assertRaisesRegex(
    ...
    def height_invalid_value_tests(self):
...
class Test_Rectangle_update_with_args(TestCase):
    ...
    def test_update_no_args(self):
        r = Rectangle(2, 6, 1, 2, 49)
        r.update()
        self.assertEqual(str(r), "[Rectangle] (49) 1/2 - 2/6")

    def test_update_args_none_id(self):
        r = Rectangle(2, 6, 1, 2, 49)
        r.update(None)
        self.assertEqual(str(r), "[Rectangle] (1) 1/2 - 2/6")

    def test_update_args_id(self):
        r = Rectangle(2, 4, 1, 2, 49)
        r.update(29)
        self.assertEqual(str(r), "[Rectangle] (29) 1/2 - 2/4")

    def test_update_args_id_width(self):
        r = Rectangle(2, 4, 1, 2, 49)
        r.update(29, 20)
        self.assertEqual(str(r), "[Rectangle] (29) 1/2 - 20/4")

    def test_update_args_id_width_height(self):
        r = Rectangle(2, 4, 1, 2, 42)
        r.update(29, 20, 30)
        self.assertEqual(str(r), "[Rectangle] (29) 1/2 - 20/30")

    def test_update_args_id_width_height_x(self):
        r = Rectangle(2, 4, 1, 2, 42)
        r.update(29, 20, 30, 40)
        self.assertEqual(str(r), "[Rectangle] (29) 40/2 - 20/30")

    def test_update_args_id_width_height_x_y(self):
        r = Rectangle(2, 4, 1, 2, 42)
        r.update(29, 20, 30, 40, 50)
        self.assertEqual(str(r), "[Rectangle] (29) 40/50 - 20/30")

    def test_update_args_too_many_args(self):
        r = Rectangle(2, 4, 1, 2, 42)
        r.update(20, 20, 20, 20, 20, 70, 80)
        self.assertEqual(str(r), "[Rectangle] (20) 20/20 - 20/20")
...
class Test_Rectangle_update_with_kwargs(TestCase):
    ...
    def test_update_kwargs_id(self):
        r = Rectangle(2, 4, 1, 2, 42)
        r.update(id=98)
        self.assertEqual(str(r), "[Rectangle] (98) 1/2 - 2/4")

    def test_update_kwargs_id_width(self):
        r = Rectangle(2, 4, 1, 2, 42)
        r.update(width=20, id=98)
        self.assertEqual(str(r), "[Rectangle] (98) 1/2 - 20/4")

    def test_update_kwargs_id_width_height(self):
        r = Rectangle(2, 4, 1, 2, 42)
        r.update(width=20, id=98, height=30)
        self.assertEqual(str(r), "[Rectangle] (98) 1/2 - 20/30")

    def test_update_kwargs_id_width_height_x(self):
        r = Rectangle(2, 4, 1, 2, 42)
        r.update(width=20, id=98, x=40, height=30)
        self.assertEqual(str(r), "[Rectangle] (98) 40/2 - 20/30")

    def test_update_kwargs_id_width_height_x_y(self):
        r = Rectangle(2, 4, 1, 2, 42)
        r.update(y=50, width=20, id=98, x=40, height=30)
        self.assertEqual(str(r), "[Rectangle] (98) 40/50 - 20/30")

    def test_update_kwargs_too_many_args(self):
        r = Rectangle(2, 4, 1, 2, 42)
        r.update(y=20, width=20, id=20, x=20, height=20, betty="Alx")
        self.assertEqual(str(r), "[Rectangle] (20) 20/20 - 20/20")

    def test_update_kwargs_mixed_too_many_args(self):
        r = Rectangle(2, 4, 1, 2, 42)
        r.update(y=10, width=10, betty="Alx", id=10, x=10, height=10)
        self.assertEqual(str(r), "[Rectangle] (10) 10/10 - 10/10")

    def test_update_kwargs_args_before(self):
        r = Rectangle(2, 4, 1, 2, 42)
        r.update(62, 62, 62, y=30, x=20)
        self.assertEqual(str(r), "[Rectangle] (62) 1/2 - 62/62")

    def test_update_kwargs_not_all_mixed(self):
        r = Rectangle(2, 4, 1, 2, 44)
        r.update(y=30, x=30, height=30)
        self.assertEqual(str(r), "[Rectangle] (44) 30/30 - 2/30")

    def test_update_kwargs_only_wrong_keys(self):
        r = Rectangle(2, 4, 1, 2, 42)
        r.update(betty="Alx", Alx="betty", mub="2023")
